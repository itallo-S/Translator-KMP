package com.apps_s.translator_kmp.android.voice_to_text.data
...
import com.apps_s.translator_kmp.core.domain.util.CommonStateFlow
import com.apps_s.translator_kmp.core.domain.util.toCommonStateFlow
import com.apps_s.translator_kmp.voice_to_text.domain.VoiceToTextParser
import com.apps_s.translator_kmp.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    private val recoginizer = SpeechRecognizer.createSpeechRecognizer(app)
    ...
    override fun startListening(languageCode: String) {
        ...
        recoginizer.setRecognitionListener(this)
        recoginizer.startListening(intent)
        _state.update {
            it.copy(
                isSpeaking = true
            )
